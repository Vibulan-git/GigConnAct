...
function renderLandingPage(container, onNavigate) {
    ...
    container.innerHTML = `
        <div class="landing-page-wrapper" style="position: relative; overflow: hidden; padding-bottom: 5rem; margin: 0; width: 100%;">
            ...
            <!-- 4. SECTION 3: 7 Vorteile fÃ¼r Musiker (Vibrant Purple Neon Cards with white texts) -->
            <div style="max-width: 1400px; margin: 0 auto; padding: 0.5rem 1.5rem 0;">
                <div style="text-align: center; margin-bottom: 1.8rem;">
                    <h2 style="font-family: var(--font-heading); font-size: clamp(1.6rem, 3.2vw, 2.2rem); font-weight: 900; color: var(--text-main); margin: 0;">
                        ...
                        <div class="carousel-track" id="carousel-track-benefits-musician">
                            ...
                            <div class="market-tile-card" style="background: linear-gradient(135deg, #7c3aed 0%, #6d28d9 100%); border: 2px solid #a855f7; border-radius: 14px; padding: 1.25rem; box-shadow: 0 10px 25px rgba(124, 58, 237, 0.45); display: flex; flex-direction: column; justify-content: space-between;">
                                <div>
                                    ...
                                    <p style="margin: 0; font-size: 0.84rem; color: #ffffff; font-weight: 500; line-height: 1.45; padding-left: 1.8rem; opacity: 0.95;">Event-Art, Entfernung, Gage, VerfÃ¼gbarkeit etc.</p>
                                </div>
                            </div>
                            ...
                            <div class="market-tile-card" style="background: linear-gradient(135deg, #7c3aed 0%, #6d28d9 100%); border: 2px solid #a855f7; border-radius: 14px; padding: 1.25rem; box-shadow: 0 10px 25px rgba(124, 58, 237, 0.45); display: flex; flex-direction: column; justify-content: space-between;">
                                <div>
                                    ...
                                    <p style="margin: 0; font-size: 0.84rem; color: #ffffff; font-weight: 500; line-height: 1.45; padding-left: 1.8rem; opacity: 0.95;">Nicht nur Anfragen an Veranstalter senden â€“ sondern auch erhalten</p>
                                </div>
                            </div>
                            ...
                            <div class="market-tile-card" style="background: linear-gradient(135deg, #7c3aed 0%, #6d28d9 100%); border: 2px solid #a855f7; border-radius: 14px; padding: 1.25rem; box-shadow: 0 10px 25px rgba(124, 58, 237, 0.45); display: flex; flex-direction: column; justify-content: space-between;">
                                <div>
                                    <div style="display: flex; align-items: center; gap: 0.6rem; margin-bottom: 0.35rem;">
                                        ...
                                        <h4 style="color: #ffffff; font-weight: 900; margin: 0; font-size: 1rem;">Top-VorschlÃ¤ge</h4>
                                    </div>
                            ...
                            <div class="market-tile-card" style="background: linear-gradient(135deg, #7c3aed 0%, #6d28d9 100%); border: 2px solid #a855f7; border-radius: 14px; padding: 1.25rem; box-shadow: 0 10px 25px rgba(124, 58, 237, 0.45); display: flex; flex-direction: column; justify-content: space-between;">
                                <div>
                                    ...
                                    <p style="margin: 0; font-size: 0.84rem; color: #ffffff; font-weight: 500; line-height: 1.45; padding-left: 1.8rem; opacity: 0.95;">Preiswertes Abo-Modell (jederzeit kÃ¼ndbar)</p>
                                </div>
                            </div>
            ...
            <!-- 5. SECTION 4: 7 Vorteile fÃ¼r Veranstalter (Vibrant Blue Neon Cards with white texts) -->
            <div style="max-width: 1400px; margin: 0 auto; padding: 0.5rem 1.5rem 0;">
                <div style="text-align: center; margin-bottom: 1.8rem;">
                    <h2 style="font-family: var(--font-heading); font-size: clamp(1.6rem, 3.2vw, 2.2rem); font-weight: 900; color: var(--text-main); margin: 0;">
                        ...
                        <div class="carousel-track" id="carousel-track-benefits-organizer">
                            ...
                            <div class="market-tile-card" style="background: linear-gradient(135deg, #1e40af 0%, #2563eb 100%); border: 2px solid #60a5fa; border-radius: 14px; padding: 1.25rem; box-shadow: 0 10px 25px rgba(37, 99, 235, 0.45); display: flex; flex-direction: column; justify-content: space-between;">
                                <div>
                                    ...
                                    <p style="margin: 0; font-size: 0.84rem; color: #ffffff; font-weight: 500; line-height: 1.45; padding-left: 1.8rem; opacity: 0.95;">Coverbands, Bands, DJs, Duos, Trios, Gitarristen, SÃ¤nger etc.</p>
                                </div>
                            </div>
                            ...
                            <div class="market-tile-card" style="background: linear-gradient(135deg, #1e40af 0%, #2563eb 100%); border: 2px solid #60a5fa; border-radius: 14px; padding: 1.25rem; box-shadow: 0 10px 25px rgba(37, 99, 235, 0.45); display: flex; flex-direction: column; justify-content: space-between;">
                                <div>
                                    ...
                                    <p style="margin: 0; font-size: 0.84rem; color: #ffffff; font-weight: 500; line-height: 1.45; padding-left: 1.8rem; opacity: 0.95;">Nicht nur Anfragen an Musiker senden â€“ sondern auch erhalten</p>
                                </div>
                            </div>
