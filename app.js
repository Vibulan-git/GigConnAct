...
function renderLandingPage(container, onNavigate) {
    ...
    container.innerHTML = `
        <div class="landing-page-wrapper" style="position: relative; overflow: hidden; padding-bottom: 5rem; margin: 0; width: 100%;">
            ...
            <div style="max-width: 1400px; margin: 9.5rem auto 2.5rem; padding: 0 1.5rem; text-align: center;">
                ${bottomCtaButtonHtml}
            </div>
                        ...
                        <div style="display: flex; flex-direction: column; gap: 0.8rem;">
                            ...
                            <div style="background: rgba(124, 58, 237, 0.14); border: 1px solid rgba(124, 58, 237, 0.35); border-radius: 10px; padding: 0.8rem;">
                                ...
                                <select id="filter-budget" class="form-input" style="width: 100%; padding: 0.55rem; border-radius: 8px; border: 1px solid rgba(124, 58, 237, 0.3); background: #ffffff; color: #0f172a; font-weight: 600; font-size: 0.85rem;">
                                    ...
                                    <option value="5000">Über 2.500 â‚¬</option>
                                </select>
                            </div>
                ...
                <div class="tile-body-content" style="padding: 1.2rem 1.3rem 0.8rem; flex: 1; display: flex; flex-direction: column;">
                    ...
                    <div class="tile-info-list" style="display: flex; flex-direction: column; gap: 0.5rem; font-size: 0.88rem; color: var(--text-main); margin-bottom: 0.75rem;">
                        ...
                        <div style="display: flex; align-items: center; gap: 0.75rem;">
                            ...
                            <span>${isEvents ? (item.date || 'Termin nach Absprache') : (item.availability || 'Auf Anfrage verfÜgbar')}</span>
                        </div>
                        <div style="display: flex; align-items: center; gap: 0.75rem;">
