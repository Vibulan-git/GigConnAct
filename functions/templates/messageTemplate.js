 ...
 */
module.exports = function getMessageEmailHtml({ senderName, messageText, role }) {
    ...
    return `
        <div style="font-family: Arial, sans-serif; padding: 20px; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 12px; background: #fafafa;">
            <h2 style="color: ${brandColor}; margin-top: 0; font-size: 1.5rem;">Neue Nachricht auf GigConnAct 💬</h2>
            <p>Hallo,</p>
